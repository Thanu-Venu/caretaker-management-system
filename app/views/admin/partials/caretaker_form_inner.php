...
<div class="form-grid">
  ...
  <?php if ($mode === 'add'): ?>
    <div class="field">
      ...
      <div class="password-input-wrap">
        <input id="<?= $fp ?>-password" type="password" name="password" required placeholder="Min.8 chars:upper,lower,number,symbol" autocomplete="new-password">
  ...
  <?php else: ?>
    <div class="field">
      ...
      <div class="password-input-wrap">
        <input id="<?= $fp ?>-new-password" type="password" name="new_password" autocomplete="new-password" placeholder="Leave blank to keep current. Min. 8 chars: upper, lower, number, symbol">
        <button type="button" class="password-toggle" aria-label="Show password" tabindex="0">
          <i class="bx bx-hide" aria-hidden="true"></i>
        </button>
      </div>
