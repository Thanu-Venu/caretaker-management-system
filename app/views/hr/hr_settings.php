    ...
    <div class="settings-container">
        ...
        <section class="card profile">
            ...
            <div class="profile-body">
                <img id="profileImg" src="<?= URLROOT ?>/public/images/profiles/<?= htmlspecialchars($user['profile_pic'] ?? 'admin.png') ?>" alt="Profile">
                <form method="POST" action="<?= URLROOT ?>/hrsettings/update_profile" enctype="multipart/form-data">
        ...
        <section class="card">
            ...
            <form method="POST" action="<?= URLROOT ?>/hrsettings/change_password">
