                ...
                <tbody>
                    <?php foreach ($data['requests'] as $req): ?>
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="<?= URLROOT ?>/hr/approveChange" style="display:inline-block;">
                                    <input type="hidden" name="request_id" value="<?= $req['request_id'] ?>">
                                    <button type="submit" class="approve-btn">Approve</button>
                                </form>
                                <form method="POST" action="<?= URLROOT ?>/hr/rejectChange" style="display:inline-block; margin-left:5px;">
                                    <input type="hidden" name="request_id" value="<?= $req['request_id'] ?>">
