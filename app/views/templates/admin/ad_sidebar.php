...
<body>
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="http://localhost/CMA/public?url=admin/ad_profile_requests"><i class='bx bx-user-check'></i> Profile Requests</a></li>
      ...
      <li><a href="http://localhost/CMA/public?url=admin/ad_history"><i class='bx bx-history'></i> Logs</a></li>
