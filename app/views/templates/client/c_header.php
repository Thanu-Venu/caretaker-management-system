    ...
    <div class="header-icons">
      <div class="notification-wrapper">
        ...
        <div id="notifDropdown" class="notif-dropdown">
          ...
          <div class="see-all">
            <a href="http://localhost/CMA/public?url=client/c_notification">See All</a>
          </div>
        </div>
      </div>
      <div>
        <a href="http://localhost/CMA/public?url=client/c_settings"><i class="fas fa-user-circle"></i></a>
      </div>
    </div>
  </header>
  <script src="http://localhost/CMA/public/js/notification.js"></script>
</body>