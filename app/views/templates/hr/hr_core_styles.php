<?php
/**
 * HR layout CSS — forks of admin shell files under public/css/hr/.
...
<link rel="stylesheet" href="<?= URLROOT ?>/public/css/hr/hr_sidebar.css">
<link rel="stylesheet" href="<?= URLROOT ?>/public/css/hr/hr-ui.css">
