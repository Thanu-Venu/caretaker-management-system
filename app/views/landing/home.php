  ...
  <header class="site-header site-header--hero mhero-header">
    <div class="mhero-header-inner">
      ...
      <div class="mhero-header-right">
        <a class="mhero-book" href="#contact">Book appointment <i class='bx bx-right-arrow-alt' aria-hidden="true"></i></a>
        ...
        <a class="mhero-icon" href="<?php echo URLROOT; ?>/?url=auth/login" aria-label="Login"><i class='bx bxs-lock-alt' aria-hidden="true"></i></a>
